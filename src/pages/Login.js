...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    if (emailRegex.test(username)) {
      try {
        const response = await fetch('https://nxb4401.uta.cloud/php/Login.php', {
          method: 'POST',
          headers: {
        ...
        if (response.status === 200) {
          ...
          if (data.status === 1) {
            ...
            } else if (data.UserType === 'ProgramCoordinator') {
              navigate('/ProfileProgCOD');
            } else if (data.UserType === 'QAO') {
              navigate('/QAOProfile');
      ...
      try {
        const response = await fetch('https://nxb4401.uta.cloud/php/Loginid.php', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
