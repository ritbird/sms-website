...
export default function ManageCourseProgramCOD() {
  ...
  const handleSubmit = async (course) => {
    try {
      const response = await fetch('https://nxb4401.uta.cloud/php/managecourse.php', {
        ...
        body: JSON.stringify(course), // Sending the specific row data for update
      });
        ...
        <div className="main-panel">
          <div className="content-wrapper">
            <div className="page-header">
              <h3 className="page-title">Program Overview and Alignment</h3>
            </div>
